...
lazyedView x y walkState =
    let
        ...
        viewBox : String
        viewBox =
            [ String.fromInt (baseX + stepX - 400 + 16)
            , " "
            , String.fromInt (baseY + stepY - 256 + 48)
            , " "
            , String.fromInt (32 * 25)
            , " "
            , String.fromInt (32 * 16)
            ]
                |> String.concat
    in
        div [ id "elm-root" ]
...
bg cx cy =
    (map
                    ...
                    |> List.indexedMap
                        (\x chip ->
                            Svg.image
                                ...
                                , Svga.height "33"
                                , Svga.width "33"
                                , Svga.x (String.fromInt (x * 32))
                                , Svga.y (String.fromInt (y * 32))
                                ]
                                []
                        )
            )
        ...
        ++ [ Svg.image
                [ Svga.x (String.fromInt cx)
                , Svga.y (String.fromInt (cy - 16))
                , Svga.width "32"
                , Svga.height "48"
