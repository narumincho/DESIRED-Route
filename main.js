...
var _user$project$DesiredRoute$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('DESIRED Route'),
			_1: {ctor: '[]'}
		});
};
...
if (typeof _user$project$DesiredRoute$main !== 'undefined') {
    _user$project$DesiredRoute$main(Elm['DesiredRoute'], 'DesiredRoute', undefined);
}
